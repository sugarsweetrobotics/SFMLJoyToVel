...
module_spec = ["implementation_id", "SFMLJoyToVel", 
		 "type_name",         "SFMLJoyToVel", 
...
# 
# 
class SFMLJoyToVel(OpenRTM_aist.DataFlowComponentBase):
...
def MyModuleInit(manager):
    SFMLJoyToVelInit(manager)

    # Create a component
    comp = manager.createComponent("SFMLJoyToVel")
